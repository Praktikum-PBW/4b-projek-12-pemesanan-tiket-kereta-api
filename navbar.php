...
<nav id="sidebar" class='mx-lt-5 bg-yellow' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=prices" class="nav-item nav-prices"><span class='icon-field'><i class="fa fa-ticket-alt "></i></span> Price</a>
				<?php endif; ?>
